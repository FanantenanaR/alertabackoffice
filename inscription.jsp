<%-- 
    ...
    Created on : 4 janv. 2022, 22:39:03
    Author     : User
--%>
...
<body>
    ...
    <form action="VerificationInscription">
          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <div class="form-outline form-white mb-4">
                  <input type="text" id="typeEmailX" class="form-control form-control-lg" name="nom" />
                <label class="form-label">Nom</label>
              </div>

              <div class="form-outline form-white mb-4">
                  <input type="text" id="typePasswordX" class="form-control form-control-lg" name="login" />
                <label class="form-label" for="typePasswordX">Login</label>
              </div>
              
              <div class="form-outline form-white mb-4">
                  <input type="password" id="typePasswordX" class="form-control form-control-lg" name="mdp1" />
                <label class="form-label" for="typePasswordX">Password</label>
              </div>
              
              <div class="form-outline form-white mb-4">
                  <input type="password" id="typePasswordX" class="form-control form-control-lg" name="mdp2" />
                <label class="form-label" for="typePasswordX">Rewrite Password</label>
              </div>
              ...
              <div>
              <p class="mb-0"><a href="Login" class="text-white-50 fw-bold">Sign In</a></p>
              </div><!-- comment -->
